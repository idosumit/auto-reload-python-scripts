...
class Handler(FileSystemEventHandler):
    def __init__(self):
        ...
        self.debounce_timers = {}  # handling rapid successive events
        ...
        if event.src_path.endswith(".py"):
            if event.src_path in self.debounce_timers:
                self.debounce_timers[
                    event.src_path
                ].cancel()  # canceling any existing timer

            # setting a debounce timer of 1 second
